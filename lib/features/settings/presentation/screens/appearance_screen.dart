...
class _AppearanceScreenState extends State<AppearanceScreen> {
  ...
  void _pushToRemote() {
    ...
    if (auth.isAuthenticated) {
      context.read<ThemeProvider>().pushTheme(auth.updateProfile);
    }
  }
      ...
      body: ListView(
        ...
        children: [
          ...
          _SectionRow(
            label: 'App Colors',
            trailing:
            tp.hasAnyCustomColor ? _ResetAllButton(onTap: _resetAll) : null,
          ),
          _ColorCard(onPush: _pushToRemote),
...
class _ColorCard extends StatelessWidget {
  ...
  const _ColorCard({required this.onPush});
