...
/// updates in real-time as the user types into the provided [controller].
class PasswordRulesChecker extends StatefulWidget {
  /// The controller for the password input field being validated.
...
class _Rule {
  ...
  /// Returns true if the [password] satisfies this rule's regex pattern.
  bool isMet(String password) => RegExp(pattern).hasMatch(password);
}

/// A private helper widget that renders a single rule row with a status icon.
