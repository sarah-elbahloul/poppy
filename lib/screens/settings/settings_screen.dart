...
/// 
/// This screen organizes app configurations into logical sections:
/// - Personalization (Themes, Fonts, Tags)
/// - Account & Security (Profile, PIN, Notifications)
...
class SettingsScreen extends StatelessWidget {
  ...
  /// Handles the export process, showing a choice dialog and success snackbar.
  ...
  /// Handles the import process, including file selection, preview, and confirmation.
  ...
  /// Opens a dialog with feedback instructions and copies email to clipboard.
...
/// Displays the user's email and sign-in status in a prominent chip.
...
/// Dialog for selecting export security (Encrypted vs Plain Text).
...
/// A selectable tile for export options.
...
/// A simple header label for settings sections.
...
/// A rounded container for grouping settings rows.
...
/// An individual interactive row in the settings list.
...
/// A divider line used between settings rows.
...
/// Final confirmation dialog for account deletion requiring typing "DELETE".
