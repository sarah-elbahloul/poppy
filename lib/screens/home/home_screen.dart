...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        _onAuthChanged();
        // Poll until encryption is ready (safety net)
        _initPollTimer = Timer.periodic(const Duration(milliseconds: 300), (_) {
          if (mounted && !_fetchedOnce && _authProvider.encryptionReady) {
            _initPollTimer?.cancel();
            _onAuthChanged();
          }
        });
      }
  ...
  void _onEntryTap(Entry entry) {
    ...
    Navigator.of(context)
      ...
      arguments: entry.id,
        ...
        .then((_) {
      // Refresh to update sync status and get latest data
    ...
    return AppBar(
      ...
      actions: [
        ...
        IconButton(
          ...
          icon: Icon(
            _sortDesc ? AppIcons.sortAsc : AppIcons.sortDesc,
